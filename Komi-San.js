...
let buttons = [
{ buttonId: 'group on', buttonText: { displayText: '🤩 𝙰𝙱𝚁𝙸𝚁 𝙶??𝚄𝙿𝙾 🤩' }, type: 1 },
...
headerType: 4,
	...
	if (isBanChat) return reply(mess.banChat)
		...
		let buttons = [
{buttonId: `${command} ren re zero`, buttonText: {displayText: '🥰 𝑆𝑖??𝑢𝑖𝑒𝑛𝑡𝑒 🥰'}, type: 1}
]
let buttonMessage = {
image: { url: result },
caption:  `𝓐𝓺𝓾𝓲 𝓽𝓲𝓮𝓷𝓮 𝓪 𝓼𝓾 𝔀𝓪𝓲𝓯𝓾 😘`,
