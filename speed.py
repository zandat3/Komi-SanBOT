...
def shell():
    ...
    printer('Haciendo prueba por %(isp)s (%(ip)s)...\n' % speedtest.config['client'],
            quiet)

    if not args.mini:
        printer('Conectando a los mejores servidores de speedtest.net...\n', quiet)
        try:
        ...
        if args.server and len(args.server) == 1:
            ...
            printer('seleccionando el mejor servidor con mejor ping...\n', quiet)
    ...
    printer('Hosteado por %(sponsor)s (%(name)s) [%(d)0.2f km]: '
